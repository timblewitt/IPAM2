...
#region variables
$ResourceGroupName = "rg-ipam-uksouth-01" #used to scope the permissions for the SPN. This is where the Storage Account is being deployed.
$RoleDefinitionName = "Storage Account Contributor"
$ADApplicationName = "AIPAS2"
$PlainPassword = "TokyoOlympics2020!"
$StorageAccountName = "hiw6ffivq3drkstorage"
$SubscriptionId = "ef620d24-2d5d-4e63-aaf9-e42cafb44dfb" #SubscriptionId where the Vnets will be deployed. E.g. the Landing Zone Subscription. If multiple Subscriptions are used rerun for each Subscription
...
New-AzADApplication -DisplayName $ADApplicationName -HomePage "https://www.timtestAIPAS.test" -IdentifierUris "https://www.timtestAIPAS.test" -Password $Password -OutVariable app
